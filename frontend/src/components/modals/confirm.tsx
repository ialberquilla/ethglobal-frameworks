...
export function Confirmation({ isOpen, setIsOpen, frameURL }:
    {
        isOpen: boolean,
                        ...
                        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <h3 className="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                                    {isLoading ? 'Your frame is being deployed' : 'Your frame is ready!'}
                                </h3>
                                <div className="mt-2">
                                    ...
                                    </div>) : (<div className="w-12 h-12 rounded-full bg-green-100 dark:bg-green-900 p-2 flex items-center justify-center mx-auto mb-3.5">
                                        ...
                                        <ul className="space-y-4 mb-4">
                                            <li>
                                                ...
                                                <label className="inline-flex items-center justify-between w-full p-5 text-gray-900 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-500 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-900 hover:bg-gray-100 dark:text-white dark:bg-gray-600 dark:hover:bg-gray-500">
                                                    <div className="block" onClick={() => open('https://axie-nft-ivanalberquilla.vercel.app')}>
                                                        <div className="w-full text-lg font-semibold">Open frame</div>
                                                        <div className="w-full text-gray-500 dark:text-gray-400">axie-nft-ivanalberquilla.vercel.app</div>
                                                    </div>
